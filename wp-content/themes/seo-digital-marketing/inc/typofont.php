...
function seo_digital_marketing_custom_styles($custom) {
	...
	if ( $seo_digital_marketing_headings_font ) {
		...
		$font_pieces = explode(":", $seo_digital_marketing_headings_font);
	...
	if ( $seo_digital_marketing_body_font ) {
		...
		$font_pieces = explode(":", $seo_digital_marketing_body_font);
	...
	wp_add_inline_style( 'seo-digital-marketing-style', $custom );

}
add_action( 'wp_enqueue_scripts', 'seo_digital_marketing_custom_styles' );

//Sanitizes Fonts
function seo_digital_marketing_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
