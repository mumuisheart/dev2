...
if ( ! class_exists( 'SEO_Digital_Marketing_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class SEO_Digital_Marketing_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new SEO_Digital_Marketing_WPTT_WebFont_Loader( $url );
