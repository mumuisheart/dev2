 ...
 * Control - Switch.
 *
 * @package SEO Digital Marketing Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class SEO_Digital_Marketing_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'seo-digital-marketing-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'seo-digital-marketing-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
