...
class SEO_Digital_Marketing_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'seo-digital-marketing' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $seo_digital_marketing_font_awesome_icon_array = seo_digital_marketing_font_awesome_icon_array();
                    foreach ($seo_digital_marketing_font_awesome_icon_array as $seo_digital_marketing_font_awesome_icon) {
                            $icon_class = $this->value() == $seo_digital_marketing_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($seo_digital_marketing_font_awesome_icon).'"></i>
                            <span class="seo-digital-marketing-social-class">'.esc_attr($seo_digital_marketing_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function seo_digital_marketing_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'seo-digital-marketing-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'seo_digital_marketing_customizer_script' );

if(!function_exists('seo_digital_marketing_font_awesome_icon_array')){
    function seo_digital_marketing_font_awesome_icon_array(){
